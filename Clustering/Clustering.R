...
silhouette_data <- data.frame(k = 2:10,
...
# Perform NBClust
NbClust(scaled_clean_wine_data, method = "kmeans")

# Get the gap statistics
fviz_nbclust(scaled_clean_wine_data, kmeans, method = "gap_stat")

#################### Perform K-Means with 2 clusters ####################
set.seed(123)
result <- kmeans(scaled_clean_wine_data, 2, nstart = 25)
result
...
set.seed(123)
result <- kmeans(scaled_clean_wine_data, 3, nstart = 25)
result
...
set.seed(123)
result <- kmeans(scaled_clean_wine_data, 4, nstart = 25)
result
